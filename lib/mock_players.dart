...
final List<Player> mockPlayers = [
  ...
  new Player(1, 'Michael', 'USA', 'Bayern Munich', 'Long shots and trying to spin (without success)'),
  new Player(15, 'Zyaid', 'Jordan', 'Real Madrid', 'Zyaiding (excessive and disgusting slide tackling)'),
  new Player(17, 'Michael', 'USA', 'Bayern Munich', 'Long shots and trying to spin (without success)')
];